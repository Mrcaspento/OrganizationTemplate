...
export class TeamMembers extends Component{
    constructor(props){
        ...
        optionsMixedChart: {
            ...
            stroke: { //the stroke is thickeness for each of the bars for each catagoire or in this case team member, have it detail employee score(mins volunteered) and another bar for events checked in to.
              width: [4, 0, 0]
            },
            xaxis: {
